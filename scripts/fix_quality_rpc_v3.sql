-- CORRECTION : "timestamp" est un mot réservé qui peut bloquer l'exécution.
-- On renomme le champ de sortie en "obs_time", ce qui correspond en plus à ce que le frontend attend.
...
RETURNS TABLE (
    id BIGINT,
    station_id TEXT,
    obs_time TIMESTAMPTZ, -- Correct column name
    param_name TEXT,
    value NUMERIC,
    threshold_msg TEXT
) AS $$
...
BEGIN
    ...
    SELECT 
        ...
        CASE 
            ...
            ELSE 'Autre'
        END::TEXT as threshold_msg -- Explicit Cast
