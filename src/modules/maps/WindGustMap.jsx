    ...
    return (
        <div className="wind-map-page" style={{ padding: '20px', background: '#f8fafc', minHeight: '100vh', fontFamily: 'Outfit, sans-serif' }}>
            ...
            <main style={{ maxWidth: '1300px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 340px', gap: '25px', paddingBottom: '30px' }}>
                <div id="wind-map-container" style={{
                    background: 'white',
                    borderRadius: '4px',
                    padding: '0',
                    boxShadow: 'none',
                    ...
                    <div style={{ position: 'absolute', bottom: '30px', left: '30px', padding: '12px 20px', background: 'rgba(255,255,255,0.85)', borderRadius: '8px', border: '1px solid #000' }}>
                    ...
                    <div style={{ position: 'absolute', bottom: '30px', right: '30px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '8px' }}>
                    ...
                    {/* Légende Verticale "Modèle MF" (Intégrée pour le téléchargement) */}
                    <div style={{
                        position: 'absolute',
                        top: '40px',
                        right: '30px',
                        ...
                        <div style={{ fontSize: '11px', fontWeight: '1000', marginBottom: '8px', color: '#000' }}>km/h</div>
                        <div style={{ display: 'flex', flexDirection: 'column-reverse' }}>
                            {WIND_SCALE.filter(r => r.min >= 60).map((range, idx) => (
                                <div key={range.min} style={{ display: 'flex', alignItems: 'center' }}>
                                    <div style={{
                                        width: '24px',
                                        height: '18px',
                            ...
                            {/* Le top de la légende (180+) */}
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <div style={{ width: '24px', height: '18px', background: '#e6d8ff', border: '0.5px solid #000', borderBottom: 'none' }} />
                                <div style={{ fontSize: '11px', fontWeight: '1000', marginLeft: '10px', width: '30px', color: '#000' }}>180</div>
                            </div>
                        </div>
                    </div>
                </div>
